...
import { 
  ArrowRight, Briefcase, CheckCircle, Target, FileText, Database, Clipboard
} from 'lucide-react'
...
export default function BackOfficeBPOPage() {
  const services = [
    ...
    },
    {
      ...
      description: 'Comprehensive verification and validation processes.',
      items: [
    ...
    {
      title: 'Application/Claims Processing',
      description: 'Efficient processing of applications and claims.',
      items: [
        'Application review',
        'Claims processing',
    ...
    },
    {
      ...
      description: 'Organized and secure document handling.',
      items: [
        'Document scanning',
        'Digital archiving',
        'File organization',
  ...
  const benefits = [
    'Reduced backlog and improved efficiency',
    'Cost-effective operations',
    'Focus on core business activities',
    'Scalable support capacity',
    'Professional and accurate processing',
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-cyan-400 font-semibold mb-8 max-w-4xl">
              Efficient Operations Behind Every Great Customer Experience
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <p className="text-lg text-gray-300 leading-relaxed">
                KNS handles data entry, verification, application/claims processing, document management, and admin support to reduce backlog and keep your organisation running efficiently.
              </p>
              <p className="text-lg text-mauve-light leading-relaxed font-semibold">
                Efficient back-office operations that free up your team to focus on core business activities while ensuring accuracy and compliance.
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 50 }}
            ...
            >
              <div className="relative h-96 rounded-xl overflow-hidden shadow-xl border border-mauve/30">
                <Image
                  src="https://sa-commercial.co.za/wp-content/uploads/2022/03/back-office-header.jpeg"
                  alt="Back-Office & BPO Operations"
                  fill
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-cyan-100 mb-8 max-w-3xl mx-auto">
              Keep your organisation running efficiently with our comprehensive BPO services.
            </p>
            <Link
              href="/contact"
