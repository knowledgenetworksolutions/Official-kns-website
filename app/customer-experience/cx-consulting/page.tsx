...
import { 
  ArrowRight, Target, CheckCircle, TrendingUp, Map, BarChart, FileText
} from 'lucide-react'

export default function CXConsultingPage() {
  const services = [
    {
      title: 'Service Process Redesign',
      description: 'Transform your service delivery processes for maximum efficiency.',
      items: [
    ...
    },
    {
      ...
      description: 'Understand and optimize every customer touchpoint.',
      items: [
    ...
    {
      title: 'KPI Development & Improvement',
      description: 'Data-driven metrics for customer experience excellence.',
      items: [
    ...
    },
    {
      ...
      description: 'Service level agreements that set clear expectations.',
      items: [
    ...
    {
      title: 'Complaint System Strengthening',
      description: 'Robust complaint handling and resolution processes.',
      items: [
    ...
    {
      title: 'Overall CX Elevation',
      description: 'Comprehensive customer experience transformation.',
      items: [
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-cyan-400 font-semibold mb-8 max-w-4xl">
              Transform Your Organisation Into a Customer-Centric Leader
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <p className="text-lg text-gray-300 leading-relaxed">
                We help organisations redesign service processes, map customer journeys, improve KPIs, build SLAs, strengthen complaint systems, and elevate overall customer experience.
              </p>
              <p className="text-lg text-mauve-light leading-relaxed font-semibold">
                Strategic consulting that transforms your customer experience into a competitive advantage.
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 50 }}
            ...
            >
              <div className="relative h-96 rounded-xl overflow-hidden shadow-xl border border-mauve/30">
                <Image
                  src="https://www.shutterstock.com/image-photo/busy-african-american-business-woman-600nw-2555312991.jpg"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-cyan-100 mb-8 max-w-3xl mx-auto">
              Transform your customer experience with strategic consulting and proven methodologies.
            </p>
            <Link
              href="/contact"
