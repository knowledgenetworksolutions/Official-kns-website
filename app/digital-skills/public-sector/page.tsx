...
import { 
  ArrowRight, Building2, CheckCircle, Target, Users, Globe, Star, Badge, ShieldCheck
} from 'lucide-react'
...
export default function PublicSectorPage() {
  const trainingAreas = [
    {
      ...
      description: 'Modern digital governance frameworks and practices for public sector leadership.',
      items: [
    ...
    {
      title: 'Cloud Skills',
      description: 'Essential cloud computing skills for government operations.',
      items: [
    ...
    {
      title: 'Cyber Hygiene',
      description: 'Cybersecurity awareness and best practices for government employees.',
      items: [
        'Phishing prevention',
        'Password security',
        'Data protection',
    ...
    },
    {
      ...
      description: 'Microsoft Office Specialist (MOS) certifications for enhanced productivity.',
      items: [
    ...
    },
    {
      ...
      description: 'Skills for delivering digital public services effectively.',
      items: [
  ...
  const benefits = [
    'Strengthened government workforce capability',
    'Enhanced digital service delivery',
    'Improved operational efficiency',
    'National modernization support',
    'E-government objectives alignment',
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              Public Sector Digital Transformation Upskilling
            </h1>
            <p className="text-xl md:text-2xl text-cyan-400 font-semibold mb-8 max-w-4xl">
              Strengthening Government Workforce Capability for National Modernization
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <p className="text-lg text-gray-300 leading-relaxed">
                KNS equips civil servants with digital governance, cloud skills, cyber hygiene, productivity tools, and online service delivery competencies, supporting national modernization and e-government objectives.
              </p>
              <p className="text-lg text-mauve-light leading-relaxed font-semibold">
                Our comprehensive training programs are designed specifically for government ministries, departments, and agencies, ensuring that the public sector workforce is prepared for the digital era.
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 50 }}
            ...
            >
              <div className="relative h-96 rounded-xl overflow-hidden shadow-xl border border-mauve/30">
                <Image
                  src="https://www.worldbank.org/content/dam/photos/780x439/2019/dec/DE4A-780x439.jpg"
                  alt="Public Sector Digital Upskilling"
                  fill
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Comprehensive digital skills development for government employees
            </p>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
              Empower Your Government Teams
            </h2>
            <p className="text-xl text-cyan-100 mb-8 max-w-3xl mx-auto">
              Transform your public sector workforce with comprehensive digital skills training aligned with national modernization goals.
            </p>
            <Link
              href="/contact"
