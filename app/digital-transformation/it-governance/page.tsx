...
import { 
  ArrowRight, ShieldCheck, CheckCircle, Target, FileText, AlertTriangle, Award
} from 'lucide-react'
  ...
  const services = [
    {
      ...
      description: 'Comprehensive IT policies and procedures.',
      items: [
    ...
    },
    {
      ...
      description: 'Structured approach to IT risk management.',
      items: [
        'Risk assessment',
    ...
    },
    {
      ...
      description: 'Align with international standards and frameworks.',
      items: [
        'ISO 27001 alignment',
    ...
    },
    {
      ...
      description: 'Responsible and secure ICT operations.',
      items: [
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-cyan-400 font-semibold mb-8 max-w-4xl">
              Strong Governance for Sustainable Technology
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <p className="text-lg text-gray-300 leading-relaxed">
                From policy development to risk frameworks and compliance alignment (ISO, NIST, COBIT), we help organisations manage ICT responsibly and securely.
              </p>
              <p className="text-lg text-mauve-light leading-relaxed font-semibold">
                Comprehensive governance that ensures technology is managed effectively, securely, and in compliance with standards.
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 50 }}
            ...
            >
              <div className="relative h-96 rounded-xl overflow-hidden shadow-xl border border-mauve/30">
                <Image
                  src="https://t4.ftcdn.net/jpg/11/96/64/53/360_F_1196645343_ujmw4ueqPsH6iULLsjHwJ7RmvhKL5GXd.jpg"
                  alt="IT Governance, Risk & Compliance"
                  fill
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
              Govern Technology Wisely
            </h2>
            <p className="text-xl text-cyan-100 mb-8 max-w-3xl mx-auto">
              Manage ICT responsibly and securely with comprehensive governance, risk, and compliance frameworks.
            </p>
            <Link
              href="/contact"
