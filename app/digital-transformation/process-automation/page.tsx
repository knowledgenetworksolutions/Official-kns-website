  ...
  const services = [
    {
      ...
      description: 'Comprehensive mapping of current business processes.',
      items: [
    ...
    },
    {
      ...
      description: 'Optimize workflows for efficiency and effectiveness.',
      items: [
    ...
    },
    {
      ...
      description: 'Automate processes using low-code platforms.',
      items: [
    ...
    },
    {
      ...
      description: 'User-friendly automation without coding.',
      items: [
    ...
    {
      title: 'Paper Process Elimination',
      description: 'Digitize paper-based processes.',
      items: [
        'Digital forms',
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-cyan-400 font-semibold mb-8 max-w-4xl">
              Automate the Routine. Accelerate Performance.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <p className="text-lg text-gray-300 leading-relaxed">
                We map, redesign, and automate workflows using low-code and no-code platforms to eliminate paper processes, reduce delays, and improve productivity.
              </p>
              <p className="text-lg text-mauve-light leading-relaxed font-semibold">
                Transform manual, time-consuming processes into efficient, automated workflows.
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 50 }}
            ...
            >
              <div className="relative h-96 rounded-xl overflow-hidden shadow-xl border border-mauve/30">
                <Image
                  src="https://www.processmaker.com/wp-content/uploads/2020/10/29938-scaled.jpg"
                  alt="Business Process Automation & Workflow Redesign"
                  fill
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-cyan-100 mb-8 max-w-3xl mx-auto">
              Automate workflows and eliminate paper processes for improved productivity.
            </p>
            <Link
              href="/contact"
