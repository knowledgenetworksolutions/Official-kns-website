...
import { 
  ArrowRight, Package, CheckCircle, Target, Database, FileText, Clipboard, Tag
} from 'lucide-react'

export default function AssetManagementPage() {
  const services = [
    {
      title: 'Spare Parts Stock Management',
      description: 'Efficient management of spare parts inventory.',
      items: [
        'Inventory tracking',
    ...
    },
    {
      ...
      description: 'Structured processes for asset replacement.',
      items: [
    ...
    },
    {
      ...
      description: 'Complete documentation of asset lifecycle.',
      items: [
        'Asset history',
        'Maintenance records',
    ...
    },
    {
      ...
      description: 'Structured change management for assets.',
      items: [
        'Change requests',
        'Approval workflows',
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              Spare Parts, Inventory & Asset Management
            </h1>
            <p className="text-xl md:text-2xl text-cyan-400 font-semibold mb-8 max-w-4xl">
              Efficient Control Over Your ICT and Telecom Assets
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <p className="text-lg text-gray-300 leading-relaxed">
                We manage spare parts stock, asset tracking, warranty management, replacement workflows, lifecycle documentation, and change management procedures.
              </p>
              <p className="text-lg text-mauve-light leading-relaxed font-semibold">
                This ensures that maintenance activities are predictable, documented, and cost-efficient.
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 50 }}
            ...
            >
              <div className="relative h-96 rounded-xl overflow-hidden shadow-xl border border-mauve/30">
                <Image
                  src="https://www.shutterstock.com/image-photo/portrait-handsome-salesman-auto-parts-600nw-2477212473.jpg"
                  alt="Spare Parts, Inventory & Asset Management"
                  fill
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-cyan-100 mb-8 max-w-3xl mx-auto">
              Manage your ICT and telecom assets efficiently with comprehensive tracking and lifecycle management.
            </p>
            <Link
              href="/contact"
