...
import { 
  ArrowRight, Briefcase, CheckCircle, Target, FileText, Clipboard, BarChart, Users
} from 'lucide-react'

export default function BPOSupportPage() {
  const services = [
    {
      title: 'Data Entry',
    ...
    },
    {
      ...
      description: 'Comprehensive document verification processes.',
      items: [
        'Document review',
        'Verification checks',
    ...
    {
      title: 'Case & Claims Processing',
      description: 'Efficient processing of cases and claims.',
      items: [
        'Case review',
        'Claims processing',
    ...
    {
      title: 'Order Fulfilment Support',
      description: 'Complete order processing and fulfilment.',
      items: [
        'Order processing',
    ...
    },
    {
      ...
      description: 'Efficient workflow management and processing.',
      items: [
        'Workflow automation',
        'Process management',
        'Task coordination',
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <p className="text-lg text-gray-300 leading-relaxed">
                KNS supports your organisation with data entry, document verification, case and claims processing, order fulfilment support, workflow handling, administrative processes, and reports and analysis.
              </p>
              <p className="text-lg text-mauve-light leading-relaxed font-semibold">
                Efficient back-office operations that free up your team to focus on core business activities.
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 50 }}
            ...
            >
              <div className="relative h-96 rounded-xl overflow-hidden shadow-xl border border-mauve/30">
                <Image
                  src="https://proceragroup.com/wp-content/uploads/2024/10/Define-Clear-Objectives-And-KPIs-For-Success-1024x576.webp"
                  alt="Business Process Outsourcing (BPO) Support"
                  fill
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-cyan-100 mb-8 max-w-3xl mx-auto">
              Outsource your back-office operations for improved efficiency and focus on core business activities.
            </p>
            <Link
              href="/contact"
