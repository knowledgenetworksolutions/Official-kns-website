...
import { 
  ArrowRight, Server, CheckCircle, Target, Database, Cloud, Shield, Monitor
} from 'lucide-react'
  ...
  const services = [
    {
      ...
      description: 'Complete management of server infrastructure and virtual environments.',
      items: [
    ...
    },
    {
      ...
      description: 'Reliable data storage and backup management.',
      items: [
    ...
    },
    {
      ...
      description: 'LAN/WAN/Wi-Fi network management.',
      items: [
        'Network monitoring',
    ...
    },
    {
      ...
      description: 'Firewalls, routers, switches, and security devices.',
      items: [
        'Firewall management',
    ...
    },
    {
      ...
      description: 'Management of cloud and hybrid cloud infrastructure.',
      items: [
    ...
    {
      title: 'System Updates & Security',
      description: 'Proactive system maintenance and security hardening.',
      items: [
        'Patch management',
        'Security updates',
        'System hardening',
    ...
    },
    {
      ...
      description: 'PCs, laptops, tablets, and mobile device management.',
      items: [
        'Device provisioning',
        'Software deployment',
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
              Managed ICT Infrastructure Services
            </h1>
            <p className="text-xl md:text-2xl text-cyan-400 font-semibold mb-8 max-w-4xl">
              Let KNS Manage Your IT Environment While You Focus on Your Core Business
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              <p className="text-lg text-gray-300 leading-relaxed">
                We provide end-to-end management of your ICT infrastructure, including servers, storage, networks, cloud environments, and endpoints.
              </p>
              <p className="text-lg text-mauve-light leading-relaxed font-semibold">
                Comprehensive infrastructure management that ensures reliability, security, and optimal performance.
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 50 }}
            ...
            >
              <div className="relative h-96 rounded-xl overflow-hidden shadow-xl border border-mauve/30">
                <Image
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQvk_oabm_Xp8hLIkzfpy6IrzznnGwP4y2q-w&s"
                  alt="Managed ICT Infrastructure Services"
                  fill
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-cyan-100 mb-8 max-w-3xl mx-auto">
              Let us manage your ICT infrastructure while you focus on what matters most.
            </p>
            <Link
              href="/contact"
